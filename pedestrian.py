...
class PedestrianDataset(utils.Dataset):
    def load_pedestrian(self, dataset_dir, subset):
        """Load a subset of the Pedestrian dataset.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect pedestrians.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/pedestrian/dataset/",
                        help='Directory of the Pedestrian dataset')
